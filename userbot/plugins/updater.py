...
OFFICIAL_UPSTREAM_REPO = "https://github.com/mukul85/mukul/"
BOT_IS_UP_TO_DATE = "mukul's private userbot is up-to-date!."
NEW_BOT_UP_DATE_FOUND = (
    "**mukul's private userbot Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def deploy_start(bot, message, refspec, remote):
    ...
    await message.edit("The Latest Branch** `Master` **Has Been Pushed To Heroku** \n**Now Trying A Restart To Complete Updation Process ⚠️ !!** To Check If I am Alive Just Do `.alive` or `.help` !!!! ThankYou For Using mukul's private userbot (◍•ᴗ•◍)❤")
